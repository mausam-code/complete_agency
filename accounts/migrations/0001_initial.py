    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Super Administrator'), ('admin', 'Admin'), ('administrator', 'Administrator'), ('accountant', 'Accountant'), ('employee', 'Employee'), ('customer', 'Customer')], default='employee', max_length=20)),
                ('level', models.IntegerField(choices=[(1, 'Level 1 - Super Admin'), (2, 'Level 2 - Management'), (3, 'Level 3 - Staff/Customer')], default=3)),
