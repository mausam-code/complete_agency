...
SECRET_KEY = 'django-insecure-wfod+#@!&sec-i*s-r7$v%j_xk_wbr+1(lk@a$)67$1b*v*c&h'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'J.K. OVERSEAS PVT.LTD. Management API',
    'DESCRIPTION': 'Comprehensive company management system API with role-based access control',
    'VERSION': '1.0.0',
